...
//  DesignAppStore
//
//  Created by Steven Santiago on 8/29/20.
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("THis certicate is prroog that Meng To has acheived the UI Design course with approval from Design+Code instructior.")
                .font(.subheadline)
